...
cat app.css css/ElementList.css css/EditEntryForm.css css/NewEntryForm.css css/Navbar.css css/LikeButton.css > $TARGETFOLDER/$WEBFOLDERNAME/app.css
...
node_modules/handlebars/bin/handlebars hb/LikeButton.hb >> $TARGETFOLDER/$WEBFOLDERNAME/templates.js
